...
export const fakeTpaChanged = {
  ...
  "params": {
    "fonts": {
      "cssUrls": [
        "//static.parastorage.com/services/santa-resources/resources/viewer/user-site-fonts/v3/languages.css"
      ],
    ...
    "style": {
      ...
      "booleans": {
        ...
        "galleryShowFilters": true,
        "galleryShowSort": true,
